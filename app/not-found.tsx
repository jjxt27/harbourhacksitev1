...
export default function NotFound() {
  return (
    <div className="ground-light grid min-h-[72svh] items-center border-b border-hairline py-24">
      <Container>
        <Label as="p" className="text-ink-muted">404 / Off the chart</Label>
        <h1 className="mt-6 max-w-[12ch] font-display text-display-1 font-extrabold uppercase">
          This page never left the harbour.
        </h1>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-7">
          ...
          <Link href="/apply" className="inline-flex items-center gap-3 rounded-full bg-tide px-7 py-4 text-body-sm font-bold uppercase tracking-[0.08em] text-accent-contrast">Apply<ArrowRight aria-hidden="true" className="size-4" /></Link>
        </div>
      </Container>
    </div>
  );
