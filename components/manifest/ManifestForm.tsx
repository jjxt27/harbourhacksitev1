    ...
    <div className="grid gap-7">
      <div>
        ...
        <input
          ...
          className="mt-2.5 w-full border-2 border-ink bg-paper px-3.5 py-3 font-display text-lg font-bold shadow-hard-sm outline-none placeholder:font-normal placeholder:text-slate focus-visible:outline-[3px] focus-visible:outline-offset-2 focus-visible:outline-orange aria-[invalid=true]:border-orange"
        />
        {errors.name ? (
          <p id={ids.nameError} className="mt-2 font-mono text-[11px] uppercase tracking-[0.1em] text-orange">
            {errors.name}
          </p>
        ) : null}
      </div>
      ...
      <fieldset>
        <legend className="font-display text-xs font-black uppercase tracking-[0.14em]">
          {manifest.fields.role.label}
        </legend>
        <p className="mt-1.5 text-sm text-slate">{manifest.fields.role.hint}</p>
      ...
      <fieldset>
        ...
        {errors.skills ? (
          <p id={ids.skillsError} className="mt-2.5 font-mono text-[11px] uppercase tracking-[0.1em] text-orange">
            {errors.skills}
          </p>
        ) : null}
      </fieldset>
      ...
      <fieldset>
        ...
        <p className="mt-1.5 text-sm text-slate">{manifest.fields.lookingFor.hint}</p>
