...
## 01 · Why n8n, specifically

Most hackathon sponsorships put a tool in front of people at the moment they're building. The problem is that the build is the part these teams already know how to do.
...
- **A mentor on the floor** during the build weekend, or office hours on the Saturday.
- **A seat on the judging panel** at pitch night, 30 October.
- **Templates.** If the workflows teams build are useful to you, they're yours — we'll ask every team to make theirs shareable as a condition of the prize category.

---

## 04 · What n8n gets back
...
**Sydney presence in a room that skews early.** Students, people working, people between things — the group that picks its automation stack once and keeps it for a decade.

**Build-in-public output.** Teams post through the weekend and the week after; we amplify. Partner billing on the site, the registration flow and event collateral.

**The pitch night on 30 October**, with your prize category decided in front of the room.

---

## 05 · Straight about the stage we're at

This is the first HarbourHack.

We're not going to quote you an attendance number, a reach figure or an impressions estimate, because every one of those would be invented and you'd be right not to believe them.
...
| Prizes | TBC |
| Cohort size and capacity | TBC |
| Partner roster | Being finalised — happy to walk through it on the call |
...
## Cold email — skeleton, not copy-paste
